...
CNPG's [`postInitApplicationSQL`](https://cloudnative-pg.io/docs/1.30/bootstrap#executing-queries-after-initialization) runs as `postgres` against the application database.
...
From here the [live-migration runbook](live-migration.md) applies unchanged.
