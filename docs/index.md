...
**In development.** One-shot clone and live migration with follow and controlled cutover are functional and e2e-tested; verification shipped with envtest coverage.
The API is v1beta1 (v1alpha1 stays served but is deprecated) and may still change.
