...
- [x] Cherry-pick #211 from `972781357628526a220db172f157398e2090599c` before the other implementation work.
- [x] Remove the disposable workflow path, observer, documentation, and their tests.
  Retain the native shared-cluster workflow path and add CI-run regression assertions for that boundary.
- [x] Isolate #223 from `48d091453d93222f0d3555157b90513ed5976ab7` without #243 worker-session behavior.
- [x] Apply only the #210 Pending-status and approved #200 scheduling hunks from the `a62ef17..43f5127` controller diff, with focused tests and documentation.
- [x] Reconcile the shared controller and E2E registration files after the focused changes land.
- [x] Confirm that the combined diff excludes #215, #243, #209, #221, #88, and any new coverage-summary behavior.
