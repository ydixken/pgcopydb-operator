...
const (
	...
	// roughly a third of a clone's wall clock, during which the target stops
...
// +kubebuilder:deprecatedversion:warning="pgcopydb-operator.io/v1alpha1 Migration is deprecated; use v1beta1"
